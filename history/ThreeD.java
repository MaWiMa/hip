/* ThreeD.java nore 14.jul.2000 depricated tags bearbeitet 13/15
 * orig javadoc/demos/WireFrame/ThreeD.java
...
//new
	Reader r = new BufferedReader(new InputStreamReader(is));
 	StreamTokenizer st = new StreamTokenizer(r);	
//deprecated	StreamTokenizer st = new StreamTokenizer(is);
...
//nore	faellt mir nix ein	gr[i] = new Color(grey, grey, grey);
...
//deprecated	resize(size().width <= 20 ? 400 : size().width,
...
//new    	protected void processMouseEvent(MouseEvent e) {
...
//new	protected void processMouseMotionEvent(MouseEvent e, int x, int y) {
//deprecated
...
//
	...
	if (md != null) {
	    ...
	    md.mat.translate(-(md.xmin + md.xmax) / 2,
			     ...
			     -(md.zmin + md.zmax) / 2);
	    md.mat.mult(amat);	
//nore Pseudosichtbarkeit	    md.mat.scale(xfac, -xfac, 8 * xfac / size().width);
